...
class Categoria {
    ...
    public function insertar($data) {
        ...
        $this->_misql->sql = "INSERT INTO categoria(nombre, descripcion) VALUES('" . $data["nombre"] ."', '". $data["descripcion"] ."') ";
    ...
    public function actualizar($data) {
        $this->_misql->conectar();
        $this->_misql->sql = "UPDATE categoria SET nombre='". $data["nombre"] ."', descripcion='". $data["descripcion"] ."' ";
    ...
    public function eliminar($id) {
        $this->_misql->conectar();
        $this->_misql->sql = "DELETE FROM categoria WHERE id=$id";
    ...
    public function listarSugerencia($busqueda) {
        $this->_misql->conectar();
        $this->_misql->sql = "SELECT id, nombre FROM categoria WHERE nombre like '%". $busqueda ."%' ORDER BY nombre LIMIT 10";
